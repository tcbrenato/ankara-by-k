export default function Contact() {
  const handleWhatsapp = (e) => {
    ...
    window.open(`https://wa.me/22964830195?text=${encodeURIComponent(texte)}`, "_blank");
  };
            ...
            <div>
              ...
              <div className="contact-info-item">
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <a href="tel:+2290164830195" style={{
                    fontSize: "0.9rem",
                    color: "var(--dark)",
                    fontWeight: "500",
                    textDecoration: "none",
              ...
              <div className="contact-info-item" style={{ background: "#e8f8ef" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <a href="https://wa.me/22964830195" target="_blank" rel="noreferrer" style={{
                    fontSize: "0.9rem",
                    color: "#25D366",
                    fontWeight: "500",
                    textDecoration: "none",
